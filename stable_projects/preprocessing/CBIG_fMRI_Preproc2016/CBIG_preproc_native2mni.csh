...
foreach runfolder ($bold)
	...
	parallel -j 32 CBIG_helper_preproc_native2mni_project1mm.csh {} $frame_dir $anat_s $anat_dir $MNI_ref_id \
		$MNI_ref_dir $regfile $LF \
		::: `seq 0 $nframes_dec`
	...
	parallel -j 32 CBIG_helper_preproc_native2mni_downsample2mm.csh {} $frame_dir $MNI_ref_id $temp_2mm $LF \
		::: `seq 0 $nframes_dec`
	...
	parallel -j 32 CBIG_helper_preproc_native2mni_smooth.csh {} $frame_dir $sm_mask $inverted_sm_mask $sm $LF \
		::: `seq 0 $nframes_dec`
